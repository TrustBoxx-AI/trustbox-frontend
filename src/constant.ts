/* constants.ts — TrustBox
   Single source of truth for all app-wide constants.
   Exports: API_URL · contract addresses · ENTITY_TYPES ·
            ACTION_META · ACCENT_HEX · SCORE_BANDS · FUJI_EXPLORER · HEDERA_EXPLORER
*/
...
export const SCORE_BANDS: Record<number, {
  ...
  1: { label:"Poor",      range:"300–579", color:"#ff4d6a", bg:"rgba(255,77,106,.07)",  text:"text-red-400"    },
  2: { label:"Fair",      range:"580–669", color:"#ffb347", bg:"rgba(255,179,71,.07)",  text:"text-amber-400"  },
  3: { label:"Good",      range:"670–739", color:"#52b6ff", bg:"rgba(82,182,255,.07)",  text:"text-blue-400"   },
  4: { label:"Excellent", range:"740–850", color:"#00e5c0", bg:"rgba(0,229,192,.07)",   text:"text-teal-400"   },
};

/* ── Accent hex lookup (accentVar → hex) ─────────────── */
...
/* ── Entity types (used by Landing + AddEntityModal) ─── */
...
/* ── Ticker items ────────────────────────────────────── */
export const TICKER_ITEMS: { t: string; c: string }[] = [
  { t: "AGENT VERIFIED · agt_sec_001",          c: "#00e5c0" },
  { t: "AUDIT ANCHORED · AuditRegistry.sol",    c: "#ffb347" },
  { t: "INTENT EXECUTED · Lagos → London",      c: "#ffb347" },
  { t: "ZK PROOF GENERATED · 0x8A24…552A",      c: "#a78bfa" },
  { t: "CREDIT SCORE ISSUED · 0.0.12345",       c: "#00e5c0" },
  { t: "MARKETPLACE LISTED · agt_audit_pro",    c: "#ff6eb4" },
  { t: "CHAINLINK REQUEST · Fuji Testnet",      c: "#52b6ff" },
  { t: "TEE BLIND AUDIT COMPLETE · MyProtocol", c: "#a78bfa" },
];