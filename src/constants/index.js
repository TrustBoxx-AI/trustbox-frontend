...
export const ENTITY_TYPES = [
  {
    ...
    badge: "ERC-8004",
    badgeColor: "#52b6ff",
    desc: "Register an AI agent and mint its verifiable on-chain ERC-8004 credential NFT on Avalanche.",
    fields: [
  ...
  },
  {
    ...
    badge: "On-Chain Tx",
    badgeColor: "#ffb347",
    desc: "Audit a smart contract and anchor the signed report to AuditRegistry.sol on Avalanche.",
    fields: [
...
export const LOG_LINES = {
  verify: [
    "Initiating ERC-8004 agent verification…",
    "Fetching TrustRegistry.sol on Avalanche…",
    "Validating cryptographic identity signature…",
    "Verifying model manifest hash against registry…",
    "Cross-referencing operator record on-chain…",
    "Evaluating declared capability scope…",
    "Computing veracity score…",
    "Preparing ERC-8004 credential metadata…",
    "Uploading agent credential to IPFS…",
    "Minting ERC-8004 Agent Credential NFT on Avalanche…",
    "Awaiting block confirmation…",
    "✓ ERC-8004 credential minted. Agent identity verified on-chain.",
  ],
  audit: [
    "Loading contract bytecode from address…",
    "Running static analysis — reentrancy patterns…",
    "Running static analysis — access control…",
    "Checking integer overflow and underflow…",
    "Scanning for hardcoded keys and secrets…",
    "Auditing event log integrity (1,847 events)…",
    "Computing Merkle root of audit findings…",
    "Running regulatory alignment — NIST AI RMF…",
    "Generating signed audit report…",
    "Uploading report to IPFS…",
    "Submitting anchor tx to AuditRegistry.sol on Avalanche…",
    "Awaiting block confirmation (#29,851,204)…",
    "✓ Audit report anchored on-chain. Tx confirmed.",
  ],
  scan: [
...
export const MOCK_FINDINGS = {
  verify: [
    { label: "Identity signature",     status: "pass", detail: "Cryptographic signature valid — keypair confirmed"             },
    { label: "Model manifest hash",    status: "pass", detail: "SHA-256 hash matches registered model manifest"               },
    { label: "Operator on-chain",      status: "pass", detail: "Operator address 0x4E71…1e50 found in TrustRegistry.sol"     },
    { label: "Capability scope",       status: "warn", detail: "2 capabilities undeclared — recommend re-registration"        },
    { label: "EU AI Act Art. 52",      status: "pass", detail: "High-risk agent — transparency obligations satisfied"         },
    { label: "ERC-8004 mint",          status: "pass", detail: "Agent Credential NFT #4821 minted on Avalanche Fuji"          },
    { label: "Metadata anchored",      status: "pass", detail: "ipfs://bafybei…xk2q pinned — credential URI immutable"        },
  ],
  audit: [
    { label: "Reentrancy guard",      status: "pass", detail: "No reentrancy vulnerabilities detected in 14 functions"        },
    { label: "Access control",        status: "warn", detail: "3 functions missing access modifiers — review required"        },
    { label: "Integer safety",        status: "pass", detail: "SafeMath / Solidity 0.8+ checked arithmetic throughout"       },
    { label: "Secret detection",      status: "pass", detail: "No hardcoded private keys, seeds, or API credentials found"   },
    { label: "Event log integrity",   status: "pass", detail: "All 1,847 events hash-verified — Merkle root consistent"      },
    { label: "Dependency CVEs",       status: "warn", detail: "2 OpenZeppelin deps below latest — update recommended"        },
    { label: "Regulatory alignment",  status: "pass", detail: "NIST AI RMF · EU AI Act — compliant"                         },
    { label: "On-chain anchor tx",    status: "pass", detail: "Report hash anchored in AuditRegistry.sol — block #29,851,204" },
  ],
  scan: [
...
export const TICKER_ITEMS = [
  { c: "#52b6ff", t: "agt_8f2k9x — ERC-8004 #4821 minted — Avalanche ▲"       },
  { c: "#ff4d6a", t: "agt_3k1p0z — anomaly flagged — review required"          },
  { c: "#00e5c0", t: "workflow_0041 — scan — behavioural check OK — 87/100"    },
  { c: "#00e5c0", t: "a2a_handoff → agt_7y — ERC-8004 credential verified"     },
  { c: "#ffb347", t: "contract:0x4E71 — AuditRegistry.sol anchor — tx confirmed" },
  { c: "#52b6ff", t: "nexum.io — identity verified — ERC-8004 #4819 on Avalanche" },
  { c: "#a78bfa", t: "blindaudit_007 — TEE confirmed — 0 secrets exposed"      },
  { c: "#00e5c0", t: "credit_0x4f2a — ZK score: 781 — Hedera HCS anchored ℏ"  },
  { c: "#ffb347", t: "contract:0x9f2c — Merkle root anchored — block #29,851,204" },
  { c: "#a78bfa", t: "pipeline_0098 — blind audit — report CID pinned to IPFS" },
  { c: "#ffb347", t: "intent_0x9c1b — book NYC — executed — Chainlink confirmed" },
  { c: "#52b6ff", t: "agt_1a3d9f — ERC-8004 minted — trust score 91/100 ▲"    },
];
...
export const MOCK_PROOFS = {
  verify: {
    ...
    standard:      "ERC-8004",
    tokenId:       "4821",
    contractAddr:  "0x7B4E8f2A9C3D1e50F6a2B4c8D1e3F9A2b4C8d1e3",
    metadataURI:   "ipfs://bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi",
    mintTxHash:    "0x2d4f8a1b3c7e9f0a…2b4c8d1e",
    blockNumber:   "29,851,099",
    gasUsed:       "142,381",
    mintedAt:      "2026-03-01T14:17:34Z",
    explorerUrl:   "https://testnet.snowtrace.io/tx/0x2d4f8a1b",
    tokenExplorer: "https://testnet.snowtrace.io/token/0x7B4E8f2A?a=4821",
    agentScore:    94,
    issuer:        "TrustBox TrustRegistry v2.1",
  },
  audit: {
    chain:         "avalanche",
    registryAddr:  "0x9F2c4A7B1E3d8C6F…5A2b4C8d",
    txHash:        "0x5e2a9c1b4f8d3e7a…6c1d8b2f",
    blockNumber:   "29,851,204",
    gasUsed:       "89,412",
    auditedContract: "0x4E71A2E537B7f9D9413D3991D37958c0b5e1e503",
    reportCID:     "bafybeiczsscdsbs7ffqz55asqdf3smv6klcw3gofszvwlyarci47bgf4xe",
    reportHash:    "0x8c2a4f1b9e3d7c6a…4b2e8f1d",
    merkleRoot:    "0x3f9c1a7e2b4d8f6c…1e5a2b4c",
    auditedAt:     "2026-03-01T14:29:51Z",
    explorerUrl:   "https://testnet.snowtrace.io/tx/0x5e2a9c1b",
    registryUrl:   "https://testnet.snowtrace.io/address/0x9F2c4A7B",
    score:         76,
    standard:      "TrustBox Audit v2.1",
  },
  score: {
    chain:        "hedera",
    topicId:      "0.0.4891234",
